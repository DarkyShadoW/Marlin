...
const bool Z_MIN_ENDSTOP_INVERTING = true; // set to true to invert the logic of the endstop - fm inductive sensor is 
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  // Note: this feature occupies 10'206 byte
    ...
    // fm set my rectangle for leveling
  ...
  // fm set my offsets for the probe
